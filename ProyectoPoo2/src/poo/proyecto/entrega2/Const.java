 ...
 * diferentes niveles.
 *
 * Para construir el recinto, el diseñador de niveles genera un mapa de
 * caracteres. Se trata de un vector bidireccional (matriz) de idénticas
 ...
 * mismos números de fila y columna que la posición del mapa. A partir de ese
 * mapa de caracteres el código construye el recinto con celdas que están libres
 * o contienen obstáculos o items, según los caracteres contenidos en las
 * diferentes posiciones del mapa (ver
 * {@link  moo.proyecto.entrega1.Nivel#Nivel}).
 *
 *
 */
public class Const {

    public static final String ARCHIVO_HURACAN = "/imagenes/Huracan.png";
    public static final String ARCHIVO_ABANICO = "/imagenes/abanico.png";
    public static final String ARCHIVO_ESPADA = "/imagenes/espada.png";
    /**
     ...
     * {@link  moo.proyecto.entrega1.Nivel}) indica que en esa posición está el
     * jugador.
     */
    public static final char CELDA_POSICION_INICIAL_JUGADOR = 'J';
    /**
     * Caracter que en el mapa de caracteres de Nivel (ver
     * {@link  moo.proyecto.entrega1.Nivel}) indica que la celda está vacía.
     */
    public static final char CELDA_NORMAL = ' ';
    /**
     * Caracter que en el mapa de caracteres de Nivel (ver
     * {@link  moo.proyecto.entrega1.Nivel}) indica que en esa posición hay una
     * pared.
     */
    public static final char CELDA_PARED = '#';
    /**
     * Caracter que en el mapa de caracteres de Nivel (ver
     * {@link  moo.proyecto.entrega1.Nivel}) indica que en esa posición está la
     * puerta.
     */
    ...
    /**
     * Caracter que en el mapa de caracteres de Nivel (ver
     * {@link  moo.proyecto.entrega1.Nivel}) indica que en esa posición hay un
     * soplete.
     */
    ...
    public static final char CELDA_ESPADA = 'E';
    public static final char CELDA_HURACAN = 'V';
    public static final char CELDA_ABANICO = 'B';
}
